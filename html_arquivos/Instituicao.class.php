<?php
    class Instituicao{
        ...
        public function __construct($nome, $cnpj, $senha, $endereco, $endereco2, $cidade, $estado, $dias, $horario){
            $this->nome = $nome;
            $this->email = $cnpj;
            $this->senha = $senha;
        ...
        public function inserirInstituicao()
        {
            ...
            $sql = "INSERT INTO instituicao (nome, cnpj, senha, endereco, endereco2, cidade, estado, 
                                            diasSemanais, horario) VALUES
                                            ('$this->nome', '$this->cnpj', '$this->senha',
                                            '$this->endereco', '$this->endereco2', '$this->cidade', 
                                            '$this->estado', '$this->dias', '$this->horario')";
